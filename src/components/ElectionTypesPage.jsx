...
export default function ElectionTypesPage() {
  ...
  return (
    <div>
      <h2 style={{ fontSize: "24px", color: COLORS.navy, marginBottom: "8px" }}>Types of Elections</h2>
      <p style={{ fontSize: "16px", color: COLORS.textMuted, marginBottom: "24px" }}>India has a federal structure with multiple levels of government and elections.</p>
        ...
        {electionTypes.map((e, i) => (
          <div key={i} style={{ ...cardStyle, borderTop: `4px solid ${e.color}` }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
              ...
              <h3 style={{ margin: 0, fontSize: "18px", color: COLORS.navy }}>{e.title}</h3>
            </div>
            <p style={{ fontSize: "14px", color: COLORS.text, lineHeight: 1.6, marginBottom: "16px" }}>{e.body}</p>
            ...
            <div style={{ marginTop: "16px", background: "#f9f7f4", padding: "10px", borderRadius: "6px", fontSize: "12px", color: COLORS.textMuted, fontStyle: "italic" }}>
