  ...
  return (
    <>
        ...
        <div style={{ position: "fixed", bottom: "90px", right: "24px", width: "350px", height: "500px", background: "#fff", borderRadius: "16px", boxShadow: "0 10px 40px rgba(0,0,0,0.2)", zIndex: 1000, display: "flex", flexDirection: "column", overflow: "hidden", border: `1px solid ${COLORS.border}` }}>
          ...
          <div style={{ borderTop: `1px solid ${COLORS.border}`, padding: "12px", background: "#fff", display: "flex", gap: "8px" }}>
            <input 
              ...
              style={{ minHeight: "44px", flex: 1, padding: "10px 14px", borderRadius: "20px", border: `1px solid ${COLORS.border}`, fontFamily: "inherit", fontSize: "14px", outline: "none" }} 
              onFocus={e => { e.target.style.outline = "3px solid #FF6B00"; e.target.style.outlineOffset = "2px"; }}
              onBlur={e => e.target.style.outline = "none"}
            />
            <button 
      ...
      <button 
        ...
        onFocus={e => { e.target.style.outline = "3px solid #000"; e.target.style.outlineOffset = "2px"; }}
        onBlur={e => e.target.style.outline = "none"}
      >
        {isOpen ? "✕" : "💬"}
      </button>
