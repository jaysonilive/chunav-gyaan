...
export default function RolesPage() {
  ...
  return (
    <div>
      <h2 style={{ fontSize: "24px", color: COLORS.navy, marginBottom: "8px" }}>Key Election Officials</h2>
      <p style={{ fontSize: "16px", color: COLORS.textMuted, marginBottom: "24px" }}>The massive machinery behind the world's largest democratic exercise.</p>
          ...
          <div key={i} style={cardStyle}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px" }}>
              <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
                ...
                <h3 style={{ margin: 0, fontSize: "16px", color: COLORS.navy }}>{r.title}</h3>
              </div>
              <span style={badgeStyle(r.color)}>{r.level}</span>
            </div>
            <div style={{ marginBottom: "16px" }}>
              <div style={{ fontSize: "12px", fontWeight: "700", color: COLORS.textMuted, marginBottom: "6px" }}>Key Responsibilities:</div>
            ...
            <div style={{ background: "#f9f7f4", borderRadius: "8px", padding: "12px", display: "flex", flexDirection: "column", gap: "6px", fontSize: "12px" }}>
