...
export default function ResultsPage() {
  ...
  return (
    <div>
      <h2 style={{ fontSize: "24px", color: COLORS.navy, marginBottom: "8px" }}>Results & Certification Process</h2>
      <p style={{ fontSize: "16px", color: COLORS.textMuted, marginBottom: "24px" }}>What really happens after the last vote is cast — from EVM sealing to government formation.</p>
      <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", marginBottom: "24px" }}>
        {rSteps.map((s, i) => (
          <button 
            ...
            style={{ minHeight: "44px", minWidth: "44px", padding: "8px 14px", borderRadius: "8px", border: `2px solid ${s.color}`, background: activeStep === i ? s.color : "transparent", color: activeStep === i ? "#fff" : COLORS.text, cursor: "pointer", fontFamily: "inherit", fontSize: "12px", fontWeight: "700", transition: "all 0.2s" }}
